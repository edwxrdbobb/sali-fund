        ...
        <div className="w-full rounded-xl bg-white px-10 py-20 flex flex-col justify-center">
            <div className="social-connection-container w-full flex flex-row items-center">
                <div className="social-point w-5 h-5 rounded-full bg-purple-400 flex flex-row relative items-center">
                    <div className="absolute bottom-full -translate-y-1/4 w-fit px-4 py-2 rounded-md bg-purple-400 text-white whitespace-nowrap">SALi Fund</div>
                </div>
                ...
                <div className="social-point w-5 h-5 rounded-full bg-sky-400 flex flex-row relative items-center">
                    <div className="absolute top-full translate-y-1/4 w-fit px-4 py-2 rounded-md bg-sky-400 text-white whitespace-nowrap">Medical Funding and Specialist Access</div>
                </div>
                <div className="flex-1 h-1 bg-gray-100"></div>
                <div className="social-point w-5 h-5 rounded-full bg-amber-400 flex flex-row relative items-center">
                    <div className="absolute bottom-full -translate-y-1/4 w-fit px-4 py-2 rounded-md bg-amber-400 text-white whitespace-nowrap">Mental Health Support</div>
                </div>
                <div className="flex-1 h-1 bg-gray-100"></div>
                <div className="social-point w-5 h-5 rounded-full bg-green-400 flex flex-row relative items-center">
                    <div className="absolute top-full translate-y-1/4 w-fit px-4 py-2 rounded-md bg-green-400 text-white whitespace-nowrap">Support for FGM Victims</div>
                </div>
            </div>
        </div>  
    )
